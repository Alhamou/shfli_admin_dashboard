...
export const ViewItemMiddleColumn = ({item,isEditing,editedFields,originalItem,setEditedFields,setItem} : {item : ICreatMainItem,isEditing : boolean,editedFields : Partial<ICreatMainItem>,originalItem : ICreatMainItem | null,setEditedFields : Dispatch<SetStateAction<Partial<ICreatMainItem>>>,setItem : Dispatch<SetStateAction<ICreatMainItem | null>>}) => {
