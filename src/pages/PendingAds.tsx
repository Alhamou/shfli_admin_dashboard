...
import { Briefcase, Clock, Eye, Gavel, Hash, LayoutGrid, List, MapPin, MoreHorizontal, Search, Tag, X } from "lucide-react";
import "moment";
                  ...
                  <Table>
                    <TableHeader className="bg-gradient-to-r from-indigo-600 via-indigo-500 to-blue-500">
                      <TableRow className="hover:bg-transparent border-transparent h-16">
                        ...
                        <TableHead className="w-[280px] font-black uppercase tracking-widest text-[10px] text-white text-right">تفاصيل الإعلان</TableHead>
