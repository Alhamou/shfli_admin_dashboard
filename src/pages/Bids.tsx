                  ...
                  <Table>
                    <TableHeader className="bg-muted/50">
                      <TableRow className="hover:bg-transparent border-border/40 h-16">
                        ...
                        <TableHead className="min-w-[350px] font-black uppercase tracking-widest text-[10px] text-muted-foreground mr-1">المزاد</TableHead>
                        <TableHead className="font-black uppercase tracking-widest text-[10px] text-muted-foreground text-center">التصنيف</TableHead>
                        <TableHead className="font-black uppercase tracking-widest text-[10px] text-muted-foreground text-center">السعر الحالي</TableHead>
